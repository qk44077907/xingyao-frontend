    ...
    <div class="modify-pass">
      ...
      <div class="m-content">
        <div v-if="!modifySuc" class="info">
          <table width="100%" border="0" cellspacing="1" cellpadding="5">
            ...
            <tr>
              ...
              <td class="tdz3_right">
                ...
                <i title="打开/关闭软键盘" class="keypad-trigger"></i>
                <span class="text_hint">由字母和数字组成6-16个字符(必须包含数字与字母)且连续三位不相同,登录密码不能与提款密码相同</span>
              </td>
            </tr>
            <tr>
          ...
          <div class="list_page">
            <span>备注：请妥善保管好您的登录密码，如遗忘请使用您的提款密码重置</span>
          </div>
        ...
        <tip-box :show="tipFlag" @confirm="closeOperation">
          <div slot="msginfo" class="detail">登录密码格式错误,请重新输入<br><br>
            <p>说明：</p>
            <p>1.密码由字母与数字组成6-16个字符(必须包含数字与字母)且连续三位不相同</p>
            <p>2.登录密码不能与提款密码相同</p></div>
        </tip-box>
      </div>
    </div>
  </div>
...
<script>
  ...
  import {CHANGE_PSW} from '../../../utils/apiUrl'
